...
class Api extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Api', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ..aOS(1, 'name')
...
class Method extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Method', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..aOS(2, 'requestTypeUrl')
    ..aOB(3, 'requestStreaming')
    ..aOS(4, 'responseTypeUrl')
    ..aOB(5, 'responseStreaming')
    ..pc<$2.Option>(6, 'options', $pb.PbFieldType.PM, subBuilder: $2.Option.create)
    ..e<$2.Syntax>(7, 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $2.Syntax.SYNTAX_PROTO2, valueOf: $2.Syntax.valueOf, enumValues: $2.Syntax.values)
    ..hasRequiredFields = false
  ;
...
class Mixin extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Mixin', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..aOS(2, 'root')
    ..hasRequiredFields = false
  ;
