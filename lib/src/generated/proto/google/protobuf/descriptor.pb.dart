...
class FileDescriptorProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FileDescriptorProto', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..a<FileOptions>(8, 'options', $pb.PbFieldType.OM, defaultOrMaker: FileOptions.getDefault, subBuilder: FileOptions.create)
    ..a<SourceCodeInfo>(9, 'sourceCodeInfo', $pb.PbFieldType.OM, defaultOrMaker: SourceCodeInfo.getDefault, subBuilder: SourceCodeInfo.create)
...
class DescriptorProto_ExtensionRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DescriptorProto.ExtensionRange', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..a<ExtensionRangeOptions>(3, 'options', $pb.PbFieldType.OM, defaultOrMaker: ExtensionRangeOptions.getDefault, subBuilder: ExtensionRangeOptions.create)
  ;
...
class DescriptorProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DescriptorProto', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..a<MessageOptions>(7, 'options', $pb.PbFieldType.OM, defaultOrMaker: MessageOptions.getDefault, subBuilder: MessageOptions.create)
...
class FieldDescriptorProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FieldDescriptorProto', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..aOS(6, 'typeName')
    ..aOS(7, 'defaultValue')
    ..a<FieldOptions>(8, 'options', $pb.PbFieldType.OM, defaultOrMaker: FieldOptions.getDefault, subBuilder: FieldOptions.create)
...
class OneofDescriptorProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('OneofDescriptorProto', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..a<OneofOptions>(2, 'options', $pb.PbFieldType.OM, defaultOrMaker: OneofOptions.getDefault, subBuilder: OneofOptions.create)
  ;
...
class EnumDescriptorProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EnumDescriptorProto', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..a<EnumOptions>(3, 'options', $pb.PbFieldType.OM, defaultOrMaker: EnumOptions.getDefault, subBuilder: EnumOptions.create)
...
class EnumValueDescriptorProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EnumValueDescriptorProto', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..a<EnumValueOptions>(3, 'options', $pb.PbFieldType.OM, defaultOrMaker: EnumValueOptions.getDefault, subBuilder: EnumValueOptions.create)
  ;
...
class ServiceDescriptorProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServiceDescriptorProto', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..a<ServiceOptions>(3, 'options', $pb.PbFieldType.OM, defaultOrMaker: ServiceOptions.getDefault, subBuilder: ServiceOptions.create)
  ;
...
class MethodDescriptorProto extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MethodDescriptorProto', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..aOS(2, 'inputType')
    ..aOS(3, 'outputType')
    ..a<MethodOptions>(4, 'options', $pb.PbFieldType.OM, defaultOrMaker: MethodOptions.getDefault, subBuilder: MethodOptions.create)
...
class FileOptions extends $pb.GeneratedMessage {
  ...
  $core.bool get phpGenericServices => $_get(17, false);
  ...
  $core.String get phpMetadataNamespace => $_getS(18, '');
  ...
  $core.String get rubyPackage => $_getS(19, '');
...
class UninterpretedOption extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UninterpretedOption', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ...
    ..a<Int64>(4, 'positiveIntValue', $pb.PbFieldType.OU6, defaultOrMaker: Int64.ZERO)
