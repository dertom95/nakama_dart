...
class Type extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Type', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ...
    ..e<Syntax>(6, 'syntax', $pb.PbFieldType.OE, defaultOrMaker: Syntax.SYNTAX_PROTO2, valueOf: Syntax.valueOf, enumValues: Syntax.values)
...
class Field extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Field', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ..e<Field_Kind>(1, 'kind', $pb.PbFieldType.OE, defaultOrMaker: Field_Kind.TYPE_UNKNOWN, valueOf: Field_Kind.valueOf, enumValues: Field_Kind.values)
    ..e<Field_Cardinality>(2, 'cardinality', $pb.PbFieldType.OE, defaultOrMaker: Field_Cardinality.CARDINALITY_UNKNOWN, valueOf: Field_Cardinality.valueOf, enumValues: Field_Cardinality.values)
...
class Enum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Enum', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ...
    ..a<$0.SourceContext>(4, 'sourceContext', $pb.PbFieldType.OM, defaultOrMaker: $0.SourceContext.getDefault, subBuilder: $0.SourceContext.create)
    ..e<Syntax>(5, 'syntax', $pb.PbFieldType.OE, defaultOrMaker: Syntax.SYNTAX_PROTO2, valueOf: Syntax.valueOf, enumValues: Syntax.values)
    ..hasRequiredFields = false
  ;
...
class EnumValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EnumValue', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ..aOS(1, 'name')
...
class Option extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Option', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..a<$1.Any>(2, 'value', $pb.PbFieldType.OM, defaultOrMaker: $1.Any.getDefault, subBuilder: $1.Any.create)
    ..hasRequiredFields = false
  ;
