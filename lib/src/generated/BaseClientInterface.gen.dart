...
ResponseFuture<void> updateGroup(final NakamaSession session,{@required final String groupId,final String name,final String description,final String langTag,final String avatarUrl,final bool open});
...
/// @param create Register the account if the user does not already exist.
/// @param username Set the username on the account at register. Must be unique.
Future<NakamaSession> authenticateGameCenter({final String salt,final String signature,final String publicKeyUrl,final String playerId,final String bundleId,final int timestampSeconds,final bool create,final String username});
...
ResponseFuture<LeaderboardRecord> writeLeaderboardRecord(final NakamaSession session,{@required final String leaderboardId,final String metadata,final int score,final int subscore});
...
/// @param session The session you want to operate on
ResponseFuture<void> unlinkEmail(final NakamaSession session,{final String password,final String email});
