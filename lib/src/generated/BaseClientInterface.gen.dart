...
/// @param session The session you want to operate on
ResponseFuture<void> updateAccount(final NakamaSession session,{final String timezone,final String username,final String displayName,final String avatarUrl,final String langTag,final String location});
...
/// @param session The session you want to operate on
ResponseFuture<Group> createGroup(final NakamaSession session,{final bool open,final int maxCount,final String name,final String description,final String langTag,final String avatarUrl});
...
/// @param session The session you want to operate on
ResponseFuture<void> unlinkGameCenter(final NakamaSession session,{final String salt,final String signature,final String publicKeyUrl,final String playerId,final String bundleId,final int timestampSeconds});
...
/// @param create Register the account if the user does not already exist.
/// @param username Set the username on the account at register. Must be unique.
Future<NakamaSession> authenticateGameCenter({final String playerId,final String bundleId,final int timestampSeconds,final String salt,final String signature,final String publicKeyUrl,final bool create,final String username});
/// Add Apple's GameCenter to the social profiles on the current user's account.
/// @param session The session you want to operate on
ResponseFuture<void> linkGameCenter(final NakamaSession session,{final String salt,final String signature,final String publicKeyUrl,final String playerId,final String bundleId,final int timestampSeconds});
