...
abstract class BaseClientInterface {
  ...
  ResponseFuture<void> addGroupUsers(final NakamaSession session,
      {@required final String groupId, final List<String> userIds});
  ...
  /// @param session The session you want to operate on
  ResponseFuture<void> unlinkGoogle(final NakamaSession session,
      {final String token});
  ...
  ResponseFuture<GroupList> listGroups(final NakamaSession session,
      {final String name, final String cursor, final int limit});

  /// Create a new group with the current user as the owner.
  /// @param session The session you want to operate on
  ResponseFuture<Group> createGroup(final NakamaSession session,
  ...
  /// @param session The session you want to operate on
  ResponseFuture<void> deleteStorageObjects(final NakamaSession session,
      {final List<DeleteStorageObjectId> objectIds});

  /// Remove the custom ID from the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> unlinkCustom(final NakamaSession session,
      {final String id});

  /// Remove Apple's GameCenter from the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> unlinkGameCenter(final NakamaSession session,
  ...
  ResponseFuture<void> deleteNotifications(final NakamaSession session,
  ...
  /// @param session The session you want to operate on
  ResponseFuture<void> unlinkApple(final NakamaSession session,
      {final String token});
  ...
  ResponseFuture<void> demoteGroupUsers(final NakamaSession session,
      {@required final String groupId, @required final List<String> userIds});
  ...
  Future<NakamaSession> authenticateApple(
      {final String token, final bool create, final String username});

  /// Remove the device ID from the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> unlinkDevice(final NakamaSession session,
      {final String id});

  /// Add a custom ID to the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> linkCustom(final NakamaSession session,
      {final String id});

  /// Add Facebook Instant Game to the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> linkFacebookInstantGame(final NakamaSession session,
      {final String signedPlayerInfo});

  /// Remove Facebook Instant Game profile from the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> unlinkFacebookInstantGame(final NakamaSession session,
      {final String signedPlayerInfo});

  /// Update fields in a given group.
  /// @param session The session you want to operate on
  /// @param groupId The ID of the group to update.
  ResponseFuture<void> updateGroup(final NakamaSession session,
  ...
  ResponseFuture<void> deleteGroup(final NakamaSession session,
      {@required final String groupId});

  /// Immediately join an open group, or request to join a closed one.
  /// @param session The session you want to operate on
  /// @param groupId The group ID to join. The group must already exist.
  ResponseFuture<void> joinGroup(final NakamaSession session,
      {@required final String groupId});
  ...
  Future<NakamaSession> authenticateDevice(
      {final String id, final bool create, final String username});

  /// Add an Apple ID to the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> linkApple(final NakamaSession session,
      {final String token});

  /// Remove Steam from the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> unlinkSteam(final NakamaSession session,
      {final String token});
  ...
  ResponseFuture<GroupUserList> listGroupUsers(final NakamaSession session,
      {@required final String groupId,
      final int limit,
      final int state,
      final String cursor});
  ...
  /// @param session The session you want to operate on
  ResponseFuture<void> linkGoogle(final NakamaSession session,
      {final String token});
  ...
  ResponseFuture<void> linkFacebook(final NakamaSession session,
      {final String token, final bool sync_});

  /// Add Apple's GameCenter to the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> linkGameCenter(final NakamaSession session,
      {final String playerId,
      final String bundleId,
      final int timestampSeconds,
      final String salt,
  ...
  ResponseFuture<Users> getUsers(final NakamaSession session,
      {final List<String> ids,
  ...
  /// @param session The session you want to operate on
  ResponseFuture<void> updateAccount(final NakamaSession session,
      {final String username,
  ...
  ResponseFuture<Rpc> rpcFunc(final NakamaSession session,
  ...
  /// @param httpKey The authentication key used when executed as a non-client HTTP request.
  ResponseFuture<Rpc> rpcFunc2(final NakamaSession session,
      {@required final String id, final String payload, final String httpKey});

  /// Attempt to join an open and running tournament.
  /// @param session The session you want to operate on
  /// @param tournamentId The ID of the tournament to join. The tournament must already exist.
  ResponseFuture<void> joinTournament(final NakamaSession session,
      {@required final String tournamentId});

  /// Add an email+password to the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> linkEmail(final NakamaSession session,
  ...
  ResponseFuture<void> banGroupUsers(final NakamaSession session,
      {@required final String groupId, final List<String> userIds});
  ...
  ResponseFuture<FriendList> listFriends(final NakamaSession session,
      {final int limit, final int state, final String cursor});

  /// Delete one or more users by ID or username.
  /// @param session The session you want to operate on
  /// @param ids The account id of a user.
  /// @param usernames The account username of a user.
  ResponseFuture<void> deleteFriends(final NakamaSession session,
      {final List<String> ids, final List<String> usernames});

  /// Add friends by ID or username to a user's account.
  /// @param session The session you want to operate on
  /// @param ids The account id of a user.
  /// @param usernames The account username of a user.
  ResponseFuture<void> addFriends(final NakamaSession session,
      {final List<String> ids, final List<String> usernames});
  ...
  ResponseFuture<void> leaveGroup(final NakamaSession session,
      {@required final String groupId});
  ...
  /// @param ids The account id of a user.
  /// @param usernames The account username of a user.
  ResponseFuture<void> blockFriends(final NakamaSession session,
      {final List<String> ids, final List<String> usernames});

  /// Remove the email+password from the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> unlinkEmail(final NakamaSession session,
  ...
  /// @param session The session you want to operate on
  ResponseFuture<void> linkSteam(final NakamaSession session,
      {final String token});

  /// Get storage objects.
  /// @param session The session you want to operate on
  ResponseFuture<StorageObjects> readStorageObjects(final NakamaSession session,
      {final List<ReadStorageObjectId> objectIds});

  /// Write objects into the storage engine.
  /// @param session The session you want to operate on
  ResponseFuture<StorageObjectAcks> writeStorageObjects(
      final NakamaSession session,
      {final List<WriteStorageObject> objects});
  ...
  ResponseFuture<void> importFacebookFriends(final NakamaSession session,
      {final String token, final bool reset});
  ...
  ResponseFuture<void> deleteLeaderboardRecord(final NakamaSession session,
      {@required final String leaderboardId});
  ...
  /// @param session The session you want to operate on
  ResponseFuture<void> event(final NakamaSession session,
      {final String name,
  ...
  ResponseFuture<void> kickGroupUsers(final NakamaSession session,
      {@required final String groupId, final List<String> userIds});
  ...
  ResponseFuture<void> promoteGroupUsers(final NakamaSession session,
      {@required final String groupId, final List<String> userIds});

  /// Add a device ID to the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> linkDevice(final NakamaSession session,
      {final String id});

  /// Remove Facebook from the social profiles on the current user's account.
  /// @param session The session you want to operate on
  ResponseFuture<void> unlinkFacebook(final NakamaSession session,
      {final String token});
}
